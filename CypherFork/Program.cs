...
namespace CeaserCypher
{
	...
	class MainClass
	{
        ...
        ///gives the computer characters to decrypt with
		/// <summary>
        ...
        /// We can improve this algorithm by proving more characters and 
        /// allowing the user to use negative numbers
        /// <summary>
        /// Reads from file
        /// </summary>
        ...
        ///turns the users number to encryt the code
        ...
        /// <summary>
        /// the entry point of the program, where the program starts and ends
        /// </summary>
		...
		public static void Main(string[] args)
		{
			...
			}///gives the user the allowable intergers used to encrypt the message
            ///abstraction is used here as it is the input and output but inside shows
            /// the process of how it does it 
